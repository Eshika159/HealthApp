...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userStautsEditText = (EditText) findViewById(R.id.statusEditText);

        userImageProfileView = (ImageView) findViewById(R.id.profileImage);

        saveProfileBtn = (Button) findViewById(R.id.saveUserButton);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    finish();
                    Intent moveToHome = new Intent(UserProfileActivity.this, HealthCareHome.class);
